...
<section class="sec-product-detail bg0 p-t-65 p-b-60">
	<form class="" action="<?= base_url('user/product_details/'.$product['id']) ?>" method="post">
	<div class="container">
		<div class="row">
						...
						<div class="flex-w p-b-10">
							<div class="size-204 flex-w flex-m respon6-next">
								<div class="wrap-num-product flex-w m-r-20 m-tb-10">
									...
									<input class="mtext-104 cl3 txt-center num-product" type="number" name="amount" min="1" value="1">
