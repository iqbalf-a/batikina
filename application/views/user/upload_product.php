...
<!-- Shoping Cart -->
<?= form_open_multipart('user/upload_product'); ?>
<div class="container">
	<div class="row">
			...
			<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
					...
					<div class="flex-w flex-t p-t-15 p-b-30 col-md-12">
						...
						<div class="size-209 p-r-18 p-r-0-sm w-full-ssm col-md-7">
							<div class="bor8 bg0 m-b-12">
								<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="name" id="name" placeholder="Nama produk ">
				...
				<div class="row">
					<div class="flex-w flex-t p-t-15 p-b-30 col-md-12">
						...
						<div class="size-209 p-r-18 p-r-0-sm w-full-ssm col-md-7">
							<div class="bor8 bg0 m-b-12">
								<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="price" id="price" placeholder="100.000">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="flex-w flex-t p-t-15 p-b-30 col-md-12">
						...
						<div class="size-209 p-r-18 p-r-0-sm w-full-ssm col-md-7">
							<div class="bor8 bg0 m-b-12">
								<textarea rows="8" cols="80" name="details" id="details" class="stext-111 cl8 plh3 size-111 p-lr-15"></textarea>
							</div>
						</div>
					</div>
				</div>
