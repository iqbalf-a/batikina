					...
					<div class="wrap-table-shopping-cart">
						<table class="table-shopping-cart ">
							...
							<tr class="table_row">
								...
								<?php if ($tr->td_status == 1) {
									$status = "Menunggu Pembayaran";
								} elseif ($tr->td_status == 2) {
									$status = "Menunggu Konfirmasi";
								} elseif ($tr->td_status == 3) {
									$status = "Silahkan Mengirim Barang";
								} elseif ($tr->td_status == 4) {
									$status = "Barang Sudah Dikirim, Menunggu Konfirmasi Pembeli Menerima Barang";
								} elseif ($tr->td_status == 0) {
									$status = "Transaksi Selesai";
								}?>
								<td class="my-column"><?= $status ?></td>
